...
int
portal(FILE *f, Lexicon *l, char *s)
{
...
build(FILE *f, Lexicon *l, char *name, char *srcpath)
{
	...
	fputs("</head>", f);
	fputs("<body>", f);
	fputs("<header><a href='home.html'><img src='../media/interface/logo.svg' alt='" NAME "' height='100'></a></header>", f);
	fputs("<main>\n\n", f);
	...
	fputs("\n\n</main>", f);
	fputs("<footer><hr />", f);
	fputs("Hundredrabbits © 2021 — <a href='https://github.com/hundredrabbits/100r.co/blob/master/LICENSE.by-nc-sa-4.0.md' target='_blank'>BY-NC-SA 4.0</a>", f);
	fputs("</footer>", f);
	fputs("</body></html>", f);
