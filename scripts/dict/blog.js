...
Diary
  ...
  Rainy with a chance of mosquitoes
    ...
    Text
      ...
      & These kids were fearless, they made a game of it, just like they made a game of swimming where the waves break on the shore. The island doesn't have a reef, so when the tide comes in, large swells race to shore, and then the water explodes upwards as it hits the standing surface with a cloud CLAP! There was no beach there, at low-tide the bottom was just mud and rocks, mostly rocks, polished after years of being caressed by the sea. The waves hitting the wall were considerable, even so, the kids would grab a street sign, an advertisement, whatever they could find that could be used as a body-board, and they'd sit in the water, waiting for the waves to come. The waves always did come, and buried them all in an instant, the kids laughed, they'd played this game a hundred times.
      ...
      - "It's so similar to the writing here," I thought to myself. "Shit! I know a bit of Marquesan! Well, Hawaiian, but it has to be similar to Marquesan isn't it? The two sets of islands being so close?"
      & I wasn't entirely wrong there, both fall under central eastern polynesian, which is sub-divided into Marquesic – encompassing Marquesan AND Hawaiian – and Tahitic. All Polynesian languages show strong similarity, particularly in vocabulary. 'Mele kalikimaka' is Hawaiian, and means 'merry christmas', or at least that's what the song says it means. After reading more about it, I learned that the only central eastern polynesian words I knew were actually the Hawaiian equivalent of katakana in Japanese. The polynesians had no notion of religion or christmas, that is, until the missionaries arrived. Because the word didn't exist, Hawaiians opted for a phonetic translation of merry christmas instead of making a new word for it (with reason). 
