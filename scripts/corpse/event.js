function Event(date,data)
{
  ...
  this.el.innerHTML = ""
  this.el.innerHTML += this.type == "video" ? `<a href='`+this.link+`' target='_blank'><media style='background-image:url(media/content/event.`+(this.name ? this.name.replace(/ /g,'.').toLowerCase() : '')+`.jpg)'></media></a>` : ''
